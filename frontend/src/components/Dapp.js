            ...
            <div className="container p-4">
                ...
                {this.state.forSale1.name && (
                    ...
                    <div className="row">
                        ...
                        <div className="col-8">
                            ...
                            <p><small>By <a
                                href={this.state.forSale1.authorURL}>{this.state.forSale1.author}</a></small></p>
                            <p><i>{this.state.forSale1.description}</i></p>
                            <p>Available supply<b>: {this.state.forSale1.supply} shares</b> <small>(<a target="_blank"
                                                                                                       rel="noreferrer"
                                                                                                       href={this.state.forSale1.pdf}>legal
                                contract attached</a>)</small></p>
                ...
                {this.state.art1.name && (
                    ...
                    <div className="row">
                        ...
                        <div className="col-12">
                            <br/>
                            <p>You have registered <b><a
                                href={`https://goerli.etherscan.io/address/${this.state.selectedAddress}#tokentxns`}>{this.state.registered}</a></b> artworks
                                so far.</p>
                            <br/>
                        </div>
                    </div>
                ...
                {this.state.art1.name && (
                    ...
                    <div className="row">
                        ...
                        <div className="col-9">
                            ...
                            <p>NFT Instance: <b><a target="_blank" rel="noreferrer"
                                                   href={this.state.art1.nftURL}>{this.state.art1.nftInstance}</a></b>
                            </p>
                            <p>Shares Instance: <b><a target="_blank" rel="noreferrer"
                                                      href={this.state.art1.sharesURL}>{this.state.art1.sharesInstance}</a></b>
                            </p>
                            <p>Auction Instance: <b><a target="_blank" rel="noreferrer"
                                                       href={this.state.art1.auctionURL}>{this.state.art1.auctionInstance}</a></b>
                            </p>
                            <p>Lottery Instance: <b><a target="_blank" rel="noreferrer"
                                                       href={this.state.art1.lotteryURL}>{this.state.art1.lotteryInstance}</a></b>
                            </p>
                            <p>Metadata: <b><a target="_blank" rel="noreferrer"
                                               href={this.state.art1.metadata}>{this.state.art1.metadata}</a></b></p>
