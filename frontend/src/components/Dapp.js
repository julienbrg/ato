...
export class Dapp extends React.Component {
    ...
    return (
      ...
      <div className="container p-4">
        ...
        {this.state.forSale1.name && (
          ...
          <div className="row">
            ...
            <div className="col-3">
              ...
              <img src = {this.state.forSale1.nftImage} className ="img-thumbnail"></img>

              </div>
              <div className="col-9">

              <h4>{this.state.forSale1.name}</h4>
              <p><small>By {this.state.forSale1.author}</small></p>
              ...
              <button type="button" className="btn-lg btn-success mr-md-3" onClick={() => this._Bid()} >bid</button>

              <button type="button" className="btn-lg btn-warning mr-md-3">auctionEnd</button>

              <button type="button" className="btn-lg btn-danger mr-md-3">withdraw</button>
        ...
        {this.state.art1.name && (
          ...
          <p>Status: <b className="text-success">{this.state.art1.verified}</b></p>
  ...
  async _updateRegistered() {
    ...
    var a1x = await this._clerk.isThisArtworkVerified(1,0);

    if (a1x == true) {

      var ax2 = await this._clerk.getAuctionInstance(1,0);
      ...
      this.setState({ forSale1: {
        name: "Load Runner #1", // from shares
        author: "Jean-Michel", // from auction's beneficiary
        symbol: "LR1", // from shares
        ...
        secondsLeft: "?" // from auction --> we want
      } });
    }
  ...
  async _Register(name, symbol) {
	...
	"sourceMap": "249:3266:0:-:0;;;944:184;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;1038:10;1024:11;;:24;;;;;;;;;;;;;;;;;;1093:8;1075:15;:26;1058:14;:43;;;;1117:4;1111:3;;:10;;;;;;;;;;;;;;;;;;944:184;;249:3266;;;;;;"
      ...
      const auction = await prepareAuction.deploy("0x2d8553f9dda85a9b3259f6bf26911364b85556f5",30000000000000);
  ...
  async _Bid() {
    ...
    try {
      ...
      const approveMyDAI = await this._shares.approve(this.state.forSale1.auctionInstance, BigNumber.from("4000000000000000000"));
